...
public class Shenjat_Policit_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(co.tenton.admin.autoshkolla.R.layout.activity_shenjat__policit_);

        recyclerView= (RecyclerView) findViewById(co.tenton.admin.autoshkolla.R.id.recyclerViewShenjat_Policit);
        layoutManager = new LinearLayoutManager(this,LinearLayoutManager.HORIZONTAL,false);
        recyclerView.setLayoutManager(layoutManager);
        adapter = new Shenjat_Policit_RecyclerAdapter();
        recyclerView.setAdapter(adapter);

        progressBar = (ProgressBar) findViewById(co.tenton.admin.autoshkolla.R.id.progressBar_ShenjatPolicit);
        progressBarText = (TextView) findViewById(co.tenton.admin.autoshkolla.R.id.progressBarText_Shenjat_Policit);
        ...
        shenjat_Policit_BackButton = (Button) findViewById(co.tenton.admin.autoshkolla.R.id.shenjat_Policit_FormBackButton);
        ...
        btnOpenInfoForm = (Button) findViewById(co.tenton.admin.autoshkolla.R.id.shenjat_Policit_FormInfo);
