...
public class Shenjat_Policit_RecyclerAdapter extends RecyclerView.Adapter<Shenjat_Policit_RecyclerAdapter.ViewHolder> {
    ...
    private int[] shenjat_Policit_Image = {R.drawable.imageplaceholder ,R.drawable.imageplaceholder,
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            shenjat_Policit_Image = (ImageView) itemView.findViewById(R.id.shenjat_Policit_Image);
            shenjat_Policit_Description = (TextView) itemView.findViewById(R.id.shenjat_Policit_Description);
        }
    }
}
